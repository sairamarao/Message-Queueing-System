...
firstp = dict(line.strip().split('=') for line in open('Experiments/'+loc+'/first/Result_'+loc+'.py'))
secondp = dict(line.strip().split('=') for line in open('Experiments/'+loc+'/second/Result_'+loc+'.py'))
